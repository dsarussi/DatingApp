...
namespace API.Data
{
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<UserLike>().HasOne(s => s.TargetUser).WithMany(l => l.LikedByUsers).HasForeignKey(s => s.TargetUserId).OnDelete(DeleteBehavior.Cascade); // if not using sqlite, change cascade to NoAction
